...
function Sidebar() {
  ...
  // Kiểm tra cuộc hội thoại đã tồn tại giữa user đăng nhập và user được mời
  ...
  const createConversation = async () => {
    ...
    if (
      ...
      // Tạo ra cuộc hội thoại của user và lưu vào trong db "conversations" collection.
      // Cuộc hội thoại giữa user đăng nhập hiện tại và user được mời.
